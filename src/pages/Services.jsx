...
export default function Services() {
  return (
    <>
      <SEO
        title="Сервиз"
        description="Професионален сервиз за диагностика и ремонт на бетонпомпи и строителна техника. 24/7 аварийна помощ. Сертифицирани инженери."
        canonical="/serviz"
        jsonLd={[
          serviceSchema(),
          webPageSchema(
            'Сервиз',
            'Професионален сервиз за диагностика и ремонт на бетонпомпи и строителна техника. 24/7 аварийна помощ. Сертифицирани инженери.',
            '/serviz'
          ),
          breadcrumbSchema([
            { name: 'Начало', url: '/' },
            { name: 'Сервиз', url: '/serviz' },
          ]),
        ]}
      />
