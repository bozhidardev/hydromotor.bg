...
const s = (size) => size || 24;

export function IconPhone({ size }) {
  return (
    <svg width={s(size)} height={s(size)} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function IconWrench({ size }) {
  return (
    <svg width={s(size)} height={s(size)} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function IconFactory({ size }) {
  return (
    <svg width={s(size)} height={s(size)} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M2 20V8l6 4V8l6 4V8l6 4v12" />
      <line x1="2" y1="20" x2="22" y2="20" />
    </svg>
  );
}

export function IconHandshake({ size }) {
  return (
    <svg width={s(size)} height={s(size)} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function IconGraduationCap({ size }) {
  return (
    <svg width={s(size)} height={s(size)} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function IconFacebook({ size }) {
  return (
...
export function IconLinkedin({ size }) {
  return (
    <svg width={s(size)} height={s(size)} viewBox="0 0 24 24" fill="currentColor">
